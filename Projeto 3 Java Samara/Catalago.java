...
// 2 - Adicionar uma nova mídia
    ...
    /**
     * 3 - Excluir uma mídia.
     * Remove uma mídia do catálogo com base no índice escolhido pelo usuário.
     */
    public void excluirMidia() {
        ...
        for (int i = 0; i < midias.size(); i++) {
            System.out.println(i + " - " + midias.get(i).getTitulo() + " - " + midias.get(i).getArtista());
        }
     ...
     * Permite pesquisar mídias por título, artista ou gênero.
     * A lógica de pesquisa foi simplificada para uso de laços de repetição.
     */
     ...
     * Exibe o número total de mídias no catálogo e o número total de playlists.
     */
     ...
     * Remove uma playlist com base no índice escolhido pelo usuário.
     */
     ...
     * Adiciona uma mídia existente do catálogo a uma playlist existente.
     */
    public void adicionarMidiaPlaylist() {
        ...
        int indexPlaylist = Integer.parseInt(scan.nextLine());
        ...
        int indexMidia = Integer.parseInt(scan.nextLine());
    ...
    public void excluirMidiaPlaylist() {
        ...
        try {
            ...
            for (int i = 0; i < playlist.getMidias().size(); i++) {
                System.out.println(i + " - " + playlist.getMidias().get(i).getTitulo());
            }
            System.out.print("Número da mídia: ");
            int indexMidia = Integer.parseInt(scan.nextLine());
     ...
     * Exibe todas as playlists e as mídias contidas em cada uma.
     */
    public void visualizarMidiasPlaylists() {
        ...
        System.out.println("Listagem de Playlists:");
